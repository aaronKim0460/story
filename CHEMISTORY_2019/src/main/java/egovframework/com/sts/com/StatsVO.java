...
public class StatsVO {
	...
	/** 결과IP통계수 */
	private int ipStatsCo;
	
	/** 사이트 구분 */
	private String menuSiteCode;
	...
	public int getIpStatsCo() {
		return ipStatsCo;
	}
	public void setIpStatsCo(int ipStatsCo) {
		this.ipStatsCo = ipStatsCo;
	}
	public String getMenuSiteCode() {
		return menuSiteCode;
	}
	public void setMenuSiteCode(String menuSiteCode) {
		this.menuSiteCode = menuSiteCode;
	}
