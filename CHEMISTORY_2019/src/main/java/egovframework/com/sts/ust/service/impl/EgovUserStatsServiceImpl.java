...
public class EgovUserStatsServiceImpl extends AbstractServiceImpl implements
	...
	/* (non-Javadoc)
	 * @see egovframework.com.sts.ust.service.EgovUserStatsService#selectUserStatsList(egovframework.com.sts.com.StatsVO)
	 */
	public List<EgovMap> selectUserStatsList(StatsVO vo) throws Exception{
		return userStatsDAO.selectUserStatsList(vo);
	}
}
