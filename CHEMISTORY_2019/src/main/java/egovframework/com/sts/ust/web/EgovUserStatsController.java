...
public class EgovUserStatsController {
    ...
    /** log */
    protected static final Log LOG = LogFactory.getLog(EgovUserStatsController.class);
	...
	public String selectUserStats(@ModelAttribute("statsVO") StatsVO statsVO,
    	...
    	vo.setCodeId("COM012");
		model.addAttribute("COM012", cmmUseService.selectCmmCodeDetail(vo));
...
//			LOG.debug("++++++++++++++++++++++ userStats.size() : " + userStats.size());
...
//		}
     ...
     * @throws Exception
     */
    @RequestMapping("/sts/ust/selectUserStatsList.do")
    public void selectBbsStatsList(@ModelAttribute("statsVO") StatsVO statsVO, HttpServletResponse response, ModelMap model) throws Exception {
    	...
    	// 차트 데이터
		resultMap.put("userList", userStatsService.selectUserStatsList(statsVO));
