...
public class MenuCreateManageDAO extends EgovComAbstractDAO{
    ...
    public List EgovMenuCreatNierSiteMapList(MenuSiteMapVO vo) throws Exception{
		return list("menuManageDAO.EgovMenuCreatNierSiteMapList_D", vo); 
	}
	...
	List<EgovMap> selectMenuTree(MenuSiteMapVO menuSiteMapVO) throws Exception{
    	
		return (List<EgovMap>) list("menuManageDAO.selectMenuTree", menuSiteMapVO); 
	}
}
