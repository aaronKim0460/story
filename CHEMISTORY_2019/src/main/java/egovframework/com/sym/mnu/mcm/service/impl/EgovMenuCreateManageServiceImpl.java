...
//		vSiteMapName  = menuSiteMapvo.getTmp_rootPath()+"/"+menuSiteMapvo.getBndeFileNm();
	...
	public List EgovMenuCreatNierSiteMapList(MenuSiteMapVO vo) throws Exception {
   		return menuCreateManageDAO.EgovMenuCreatNierSiteMapList(vo);
	}
	
	/* (non-Javadoc)
	 * @see egovframework.com.sym.mnu.mcm.service.EgovMenuCreateManageService#selectMenuTree(egovframework.com.sym.mnu.mcm.service.MenuSiteMapVO)
	 */
	public List<EgovMap> selectMenuTree(MenuSiteMapVO menuSiteMapVO) throws Exception{
		
		return menuCreateManageDAO.selectMenuTree(menuSiteMapVO);
	}
