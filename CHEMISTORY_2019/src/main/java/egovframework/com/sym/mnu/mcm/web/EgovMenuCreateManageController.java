...
public class EgovMenuCreateManageController {
   ...
   /** EgovMenuManageService - 2016.01.13 by Day */
   @Resource(name = "meunManageService")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/user/mnu/EgovMenuCreatSiteMapList.do")
	public String EgovMenuCreatNierSiteMapList(HttpServletRequest request,
			@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, @RequestParam("siteType") String siteType,
			ModelMap model) throws Exception {
		...
		menuSiteMapVO.setAuthorCode("ROLE_ANONYMOUS"); // 일반 사이트는 모든 사용자 접속 가능
		menuSiteMapVO.setSiteType(siteType);
		List list_menulist = menuCreateManageService.EgovMenuCreatNierSiteMapList(menuSiteMapVO);
		model.addAttribute("list_menulist", list_menulist);
		/*LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		menuSiteMapVO.setCreatPersonId(user.getId());*/
		model.addAttribute("resultVO", menuSiteMapVO);

		if(siteType.trim().equals("KOR")){
			return "/kor/sm/nier-sm-0402";
		}else if(siteType.trim().equals("ENG")){
			return "/eng/et/nren-et-0101";
		}else{
			return "/common/ComSiteMap";
		}

	}
	
	@RequestMapping(value = "/user/SiteMap.do")
	public String EgovMenuCreatUserSiteMapList(HttpServletRequest request,
			@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, @RequestParam("siteType") String siteType,
			ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/menuTree.do")
	public void menuTree(@ModelAttribute("menuCreatVO") MenuSiteMapVO menuSiteMapVO, HttpServletResponse response) throws Exception {
		
		String msg = "Y";
		List<EgovMap> menuList = menuCreateManageService.selectMenuTree(menuSiteMapVO);
