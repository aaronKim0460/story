...
public class ProgrmManageDAO extends EgovComAbstractDAO {
	...
	public List selectProgrmFileList(ComDefaultVO vo) throws Exception{
		return list("progrmManageDAO.selectProgrmFileList", vo);
	}
	
	public int selectProgrmFileListTotCnt(ComDefaultVO vo) {
        return (Integer)getSqlMapClientTemplate().queryForObject("progrmManageDAO.selectProgrmFileListTotCnt", vo);
    }	
	
	public void insertProgrmFile(ProgrmManageVO vo) throws FdlException{
		insert("progrmManageDAO.insertProgrmFile", vo);
	}
	
	public ProgrmManageVO selectProgrmFile_N(ComDefaultVO vo)throws Exception{
		return (ProgrmManageVO)selectByPk("progrmManageDAO.selectProgrmFile_N", vo); 
	}
