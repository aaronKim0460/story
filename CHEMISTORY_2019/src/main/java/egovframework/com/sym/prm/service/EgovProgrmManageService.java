...
public interface EgovProgrmManageService {
	...
	List selectProgrmFileList(ComDefaultVO vo) throws Exception;
	
	int selectProgrmFileListTotCnt(ComDefaultVO vo) throws Exception;	
	
	void insertProgrmFile(ProgrmManageVO vo) throws Exception;
	
	ProgrmManageVO selectProgrmFile_N(ComDefaultVO vo) throws Exception;
