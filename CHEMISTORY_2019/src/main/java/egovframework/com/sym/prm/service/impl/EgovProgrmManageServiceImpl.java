...
public class EgovProgrmManageServiceImpl extends AbstractServiceImpl implements EgovProgrmManageService {
	...
	public List selectProgrmFileList(ComDefaultVO vo) throws Exception {
   		return progrmManageDAO.selectProgrmFileList(vo);
	}
	
	public int selectProgrmFileListTotCnt(ComDefaultVO vo) throws Exception {
        return progrmManageDAO.selectProgrmFileListTotCnt(vo);
	}
	
	public void insertProgrmFile(ProgrmManageVO vo) throws Exception {
    	progrmManageDAO.insertProgrmFile(vo);
	}
	
	public ProgrmManageVO selectProgrmFile_N(ComDefaultVO vo) throws Exception{
     	return progrmManageDAO.selectProgrmFile_N(vo);
	}
