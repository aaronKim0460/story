...
public class ImagePaginationRenderer2 extends AbstractPaginationRenderer implements ServletContextAware{
	...
	public void initVariables(){
		...
		firstPageLabel    = "<a href=\"#pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"first prevEnd\"><img src=\"/NIER/images/nier2/bbs/page_btn_prev1.png\"  alt=\"처음\" /></a>&#160;";
        ...
        previousPageLabel = "<a href=\"#pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"previouspostslink prev\"><img src=\"/NIER/images/nier2/bbs/page_btn_prev2.png\"  alt=\"이전\" /></a>&#160;";
        currentPageLabel  = "<strong class=\"current\">{0}</strong>&#160;";
        otherPageLabel    = "<a href=\"#pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"page\">{2}</a>&#160;";
        ...
        nextPageLabel     = "<a href=\"#pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"nextpostslink next\"><img src=\"/NIER/images/nier2/bbs/page_btn_next2.png\"  alt=\"다음\" /></a>&#160;";
        ...
        lastPageLabel     = "<a href=\"#pageIndex={1}\" onclick=\"{0}({1});return false; \" class=\"last nextEnd\"><img src=\"/NIER/images/nier2/bbs/page_btn_next1.png\"  alt=\"끝\" /></a>&#160;";
	}
