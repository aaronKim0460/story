...
public interface EgovFileMngService {
     ...
     * @throws Exception
     */
    void zipFileDown(Map<String, Object> commandMap, HttpServletRequest request, HttpServletResponse response) throws Exception;
     ...
     * @throws Exception
     */
    void deleteBBSThumbFile(FileVO vo) throws Exception;
}
