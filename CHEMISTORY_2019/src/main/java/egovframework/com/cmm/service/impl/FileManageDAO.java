...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	update("FileManageDAO.updateBBSFileDetail", fvo);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("FileManageDAO.selectBBSFileIdCount", fvo);
    }
     ...
     */
    @SuppressWarnings("unchecked")
	List<EgovMap> selectFileList(String atchFileId) throws Exception {
    	
    	return (List<EgovMap>) list("FileManageDAO.selectFileListAll", atchFileId);
    }
     ...
     * @throws Exception
     */
    public void updateBBSFileDetailForThumbFileId(FileVO vo) throws Exception {
    	update("FileManageDAO.updateBBSFileDetailForThumbFileId", vo);
    }
}
