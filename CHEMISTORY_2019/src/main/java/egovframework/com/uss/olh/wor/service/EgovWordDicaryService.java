...
public interface EgovWordDicaryService {
	 ...
	 * @throws Exception
	 */
	List<?> countWordDicaryEachSentenceK(WordDicaryDefaultVO searchVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<?> countWordDicaryEachSentenceE(WordDicaryDefaultVO searchVO) throws Exception;
