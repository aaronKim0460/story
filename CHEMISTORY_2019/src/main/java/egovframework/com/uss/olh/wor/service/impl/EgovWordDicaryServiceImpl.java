...
public class EgovWordDicaryServiceImpl extends EgovAbstractServiceImpl implements EgovWordDicaryService {
	...
	/* (non-Javadoc)
	 * @see egovframework.com.uss.olh.wor.service.EgovWordDicaryService#countWordDicaryEachSentenceK(egovframework.com.uss.olh.wor.service.WordDicaryDefaultVO)
	 */
	@Override
	public List<?> countWordDicaryEachSentenceK(WordDicaryDefaultVO searchVO) throws Exception {
		return wordDicaryDAO.countWordDicaryEachSentenceK(searchVO);
	}
	
	/* (non-Javadoc)
	 * @see egovframework.com.uss.olh.wor.service.EgovWordDicaryService#countWordDicaryEachSentenceE(egovframework.com.uss.olh.wor.service.WordDicaryDefaultVO)
	 */
	@Override
	public List<?> countWordDicaryEachSentenceE(WordDicaryDefaultVO searchVO) throws Exception {
		return wordDicaryDAO.countWordDicaryEachSentenceE(searchVO);
	}
}
