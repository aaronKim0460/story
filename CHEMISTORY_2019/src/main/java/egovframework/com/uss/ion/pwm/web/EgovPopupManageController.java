...
public class EgovPopupManageController {
	...
	public String egovPopupManageUpdt(@RequestParam Map<?, ?> commandMap, PopupManageVO popupManageVO, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		if ("save".equals(sCmd)) {
			...
			String popupCn = popupManageVO.getPopupCn();
			popupCn = popupCn.replaceAll("&lt;","<");
			popupCn = popupCn.replaceAll("&gt;",">");
			popupManageVO.setPopupCn(unscript(popupCn));	// XSS 방지
			//저장
	...
	public String egovPopupManageDelete(PopupManageVO popupManageVO, @RequestParam Map<?, ?> commandMap, ModelMap model) throws Exception {
	...
	public String egovPopupManagePopupOpen(@RequestParam("fileUrl") String fileUrl, @RequestParam("stopVewAt") String stopVewAt, @RequestParam("popupId") String popupId,
		...
		model.addAttribute("result", popupManageVOs);
		return fileUrl;
	}
