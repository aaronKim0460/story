...
public class EgovUserManageServiceImpl extends AbstractServiceImpl implements EgovUserManageService {
	...
	/** newsletterIdGnrService */
	@Resource(name="newsletterIdGnrService")
	private EgovIdGnrService nlIdgenService;
	...
	@Override
	public int selectEmailData(NewsLetterVo nlvo) throws Exception {
		return userManageDAO.selectEmailData(nlvo);
	}
	 ...
	 * @throws Exception
	 */
	public List<NewsLetterVo> selectNewsLetterList(NewsLetterVo nlvo) throws Exception{
		List<NewsLetterVo> result = userManageDAO.selectNewsLetterList(nlvo);
		return result;
	}
	public int selectNewsLetterListCnt(NewsLetterVo nlvo) throws Exception{
		return userManageDAO.selectNewsLetterListCnt(nlvo);
	}
	public List<NewsLetterVo> selectNewsLetterListExcel(NewsLetterVo nlvo) throws Exception{
		List<NewsLetterVo> result = userManageDAO.selectNewsLetterListExcel(nlvo);
		return result;
	}
	
	
	@Override
	public int insertEmailData(NewsLetterVo nlvo) throws Exception {
		//고유아이디 셋팅
		String uniqId = nlIdgenService.getNextStringId();
		nlvo.setEmailId(uniqId);
		return userManageDAO.insertEmailData(nlvo);
	}

	@Override
	public int deleteEmailData(NewsLetterVo nlvo) throws Exception {
		return userManageDAO.deleteEmailData(nlvo);
	}
