...
public class UserManageDAO extends EgovComAbstractDAO{
	...
	public int selectEmailData(NewsLetterVo nlvo) {
		return (Integer) selectByPk("userManageDAO.selectEmailData", nlvo);
	}
	...
	public List<NewsLetterVo> selectNewsLetterList(NewsLetterVo nlvo) {
		return (List<NewsLetterVo>) list("userManageDAO.selectNewsLetterList", nlvo);
	}
	public int selectNewsLetterListCnt(NewsLetterVo nlvo) {
		return (Integer) selectByPk("userManageDAO.selectNewsLetterListCnt", nlvo);
	}
	public List<NewsLetterVo> selectNewsLetterListExcel(NewsLetterVo nlvo) {
		return (List<NewsLetterVo>) list("userManageDAO.selectNewsLetterListExcel", nlvo);
	}
	
	public int insertEmailData(NewsLetterVo nlvo) {
		return update("userManageDAO.insertEmailData", nlvo);
	}

	public int deleteEmailData(NewsLetterVo nlvo) {
		return update("userManageDAO.deleteEmailData", nlvo);
	}
