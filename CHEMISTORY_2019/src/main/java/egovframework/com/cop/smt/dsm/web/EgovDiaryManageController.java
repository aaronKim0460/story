...
public class EgovDiaryManageController {
			...
			****************************************************************** */
    		...
    		if(!files.isEmpty()){
    			...
    			if("N".equals(atchFileAt)){
    				List<FileVO> _result = fileUtil.parseFileInf(files, "DIARY_", 0, _atchFileId, "", thumbVO);	
    				...
    				List<FileVO> _result = fileUtil.parseFileInf(files, "DIARY_", _cnt, _atchFileId, "", thumbVO);	
    ...
    throws Exception {
        ...
        if(sCmd.equals("save")){
    		...
    		if(!files.isEmpty()){
    		 _result = fileUtil.parseFileInf(files, "DIARY_", 0, "", "", thumbVO); 
