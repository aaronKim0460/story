...
public class BBSSatisfactionDAO extends EgovComAbstractDAO {
    ...
    public void insertComSatisfaction(Satisfaction satisfaction) throws Exception {	
    	insert("BBSSatisfactionDAO.insertComSatisfaction", satisfaction);
    }
    
    @SuppressWarnings("unchecked")
    public List<SatisfactionVO> selectSatisfactionAllList(SatisfactionVO satisfactionVO) throws Exception {
	return (List<SatisfactionVO>) list("BBSSatisfactionDAO.selectSatisfactionAllList", satisfactionVO);
    }
    
    
    public int selectSatisfactionAllListCnt(SatisfactionVO satisfactionVO) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("BBSSatisfactionDAO.selectSatisfactionAllListCnt", satisfactionVO);
    }
