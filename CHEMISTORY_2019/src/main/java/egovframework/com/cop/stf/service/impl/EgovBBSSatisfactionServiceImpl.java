...
public class EgovBBSSatisfactionServiceImpl extends AbstractServiceImpl implements EgovBBSSatisfactionService {
    ...
    public void insertComSatisfaction(Satisfaction satisfaction) throws Exception {
        ...
        satisfaction.setStsfdgNo(egovStsfdgNoGnrService.getNextLongId() + "");//2011.10.18	
    	bbsSatisfactionDAO.insertComSatisfaction(satisfaction);
    }
    
    public Map<String, Object> selectSatisfactionAllList(SatisfactionVO satisfactionVO) throws Exception {
    	List<SatisfactionVO> result = bbsSatisfactionDAO.selectSatisfactionAllList(satisfactionVO);
    	int cnt = bbsSatisfactionDAO.selectSatisfactionAllListCnt(satisfactionVO);
    	float summary = bbsSatisfactionDAO.getSummary(satisfactionVO);
