...
public class BBSAttributeManageDAO extends EgovComAbstractDAO {
    ...
    public BoardMasterVO selectBBSMasterInfMenuNo(BoardMaster vo) throws Exception {
    	BoardMasterVO rvo = new BoardMasterVO();
    	Object obj = new Object();
    	
    	//menuNo값으로 bbsId 값을 추출
    	obj = selectByPk("BBSAttributeManageDAO.selectBBSIdMenuNo", vo);
    	rvo = (BoardMasterVO)obj;
    	vo.setBbsId(rvo.getBbsId());
    	
    	obj = selectByPk("BBSAttributeManageDAO.selectBBSMasterInf", vo);
    	rvo = (BoardMasterVO)obj;
    	
    	return rvo;
    }
    
    public BoardMasterVO selectBBSMasterInfNttId(BoardMaster vo) throws Exception {
    	BoardMasterVO rvo = new BoardMasterVO();
    	Object obj = new Object();
    	
    	//nttId값으로 bbsId 값을 추출
    	obj = selectByPk("BBSAttributeManageDAO.selectBBSIdNttId", vo);
    	rvo = (BoardMasterVO)obj;
    	vo.setBbsId(rvo.getBbsId());
    ...
    public BoardMasterVO selectBBSPhoto(BoardMaster vo) throws Exception {
    	BoardMasterVO rvo = new BoardMasterVO();
    	Object obj = new Object();
    	...
    	obj = selectByPk("BBSAttributeManageDAO.selectBBSPhoto", vo);
    	rvo = (BoardMasterVO)obj;
     ...
     */
    @SuppressWarnings("unchecked")
    List<EgovMap> selectBbsObjConfirmList(BoardMasterVO vo) throws Exception {
    	
    	return (List<EgovMap>) list("BBSAttributeManageDAO.selectBbsObjConfirmList", vo);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    List<EgovMap> selectContentBBSPreview(BoardVO boardVO) throws Exception {
    	
		return (List<EgovMap>) list("BBSAttributeManageDAO.selectContentBBSPreview", boardVO);
    }
     ...
     */
    @SuppressWarnings("unchecked")
	List<EgovMap> selectBBSFileList(BoardVO boardVO) throws Exception {
    	
    	return (List<EgovMap>) list("BBSAttributeManageDAO.selectBBSFileList", boardVO);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    List<EgovMap> selectSiteList() throws Exception {
    	
    	return (List<EgovMap>) list("BBSAttributeManageDAO.selectSiteList", null);
    }
     ...
     * @throws Exception
     */
    int updateBBSConfmSttus(BoardVO boardVO) throws Exception {
    	
    	return update("BBSAttributeManageDAO.updateBBSConfmSttus", boardVO);
    }
     ...
     * @throws Exception
     */
    int updateBBSConfmWaitSttus(BoardVO boardVO) throws Exception {
    	
    	return update("BBSAttributeManageDAO.updateBBSConfmWaitSttus", boardVO);
    }
}
