...
public class Satisfaction implements Serializable {
    ...
    //페이지 담당 부서(만족도)
    private String menuAdminDpt = "";
    
    //페이지 담당 부서 전화번호(만족도)
    private String menuAdminCttpc = "";
    
    //만족도 평점
    private String stsfdgAv = "";
    
    //만족도 건수
    private String stsfgCn = "";
	...
	public String getMenuAdminDpt() {
		return menuAdminDpt;
	}

	public void setMenuAdminDpt(String menuAdminDpt) {
		this.menuAdminDpt = menuAdminDpt;
	}

	public String getMenuAdminCttpc() {
		return menuAdminCttpc;
	}

	public void setMenuAdminCttpc(String menuAdminCttpc) {
		this.menuAdminCttpc = menuAdminCttpc;
	}

	public String getStsfdgAv() {
		return stsfdgAv;
	}

	public void setStsfdgAv(String stsfdgAv) {
		this.stsfdgAv = stsfdgAv;
	}

	public String getStsfgCn() {
		return stsfgCn;
	}

	public void setStsfgCn(String stsfgCn) {
		this.stsfgCn = stsfgCn;
	}
