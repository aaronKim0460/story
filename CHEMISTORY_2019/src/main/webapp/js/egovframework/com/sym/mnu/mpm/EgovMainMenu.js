...
function addTreeNode(parentNode, recursedNodes) {
	for (var i = 0; i < treeNodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			vHtmlCodeBg      ="<tr><td height='22px' class='LeftMenuBg'>";
			vHtmlCodeBgList  ="<tr><td height='22px' class='LeftMenuBgList'>";
 ...
 ******************************************************** */
 function fn_MovePage(nodeNum) {
		...
		if(nodeValues[6] == 1){
			window.open(nodeValues[5]);
			parent.main_right.location.href = path + "/EgovMovePage.do?linkPage=/common/blank";
		}else{
