...
<script type="text/javascript">
	...
	function goSearch(){
		...
		if(form.user_birthday1.value == "" || form.user_birthday1.value == "연도선택"){
			alert('생년월일을 입력해주세요.');
			
			form.user_birthday1.focus();
			return ;			
		}
		if(form.user_birthday2.value == "" || form.user_birthday2.value == "월선택"){
			alert('생년월일을 입력해주세요.');
			
			form.user_birthday2.focus();
			return ;			
		}
		if(form.user_birthday3.value == "" || form.user_birthday3.value == "일선택"){
			alert('생년월일을 입력해주세요.');
			
			form.user_birthday3.focus();
			return ;			
		}
          ...
          <div class="conSec">
            ...
            <div class="conBox">
              ...
              <input type="hidden" name="gisu" id="gisu" value="6">
              	<dl>
                	<dd>성명</dd>
                    <dt><input type="text" name="user_nm" id="user_nm" value="<%=strUserNm2 %>" class="input" style="width:220px" onkeydown="inputCheck_board('user_nm')" onkeyup="inputCheck_board('user_nm')"/></dt>
                </dl>
                <dl style="padding-top: 4px;">
                    ...
                    <dt>
                        ...
                        -
                        <input type="text" name="user_cell_no2" id="user_cell_no2" value="<%=strUserCellNo2 %>" class="input" style="width:45px" maxlength="4" onkeypress="nonHangulSpecialKey()" onkeydown="inputCheck_board('user_cell_no2')" onkeyup="inputCheck_board('user_cell_no2')"/>
                        -
                        <input type="text" name="user_cell_no3" id="user_cell_no3" value="<%=strUserCellNo3 %>" class="input" style="width:45px" maxlength="4" onkeypress="nonHangulSpecialKey()" onkeydown="inputCheck_board('user_cell_no3')" onkeyup="inputCheck_board('user_cell_no3')" />
                    </dt>
                </dl>
                    ...
                    <tbody>
                    	...
                    	if( nCount>0 ) {
                    		for( int i=0; i<nCount; i++ ) {
                    			String pn = data.getString("part_name",i);
                    			String spn = CommonUtil.nullCheck(data.getString("sub_part_name",i), "");
                    			String spn2 = "";
