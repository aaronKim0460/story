...
<img src='./img/kid_pb_03.gif' align=absmiddle usemap="#mainWc">
<map name="mainWc">
  <area shape="rect" coords="470,47,588,68" href="./" onfocus="blur()"><!-- 집으로 -->
  <area shape="rect" coords="335,409,400,434" href="./kid_pb_02.jsp" onfocus="blur()"><!-- 이전 -->
  <area shape="rect" coords="416,409,427,434" href="./kid_pb_01.jsp" onfocus="blur()"><!-- 1 -->
  ...
  <area shape="rect" coords="524,409,589,434" href="./kid_pb_04.jsp" onfocus="blur()"><!-- 다음 -->
</map>
