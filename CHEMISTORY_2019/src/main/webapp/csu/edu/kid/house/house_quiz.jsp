			...
			<div id="ly_dtl">
				...
				<table cellspacing="0" cellpadding="0" class="cnt_title">
					<tr>
						...
						<td><div class="lctn_txt"><a href="/csu/">홈으로</a> / <a href="/csu/edu/kid/gate.jsp">케미에듀</a> / 어린이 / <a href='./'>집</a> / 퀴즈</div></td>
					</tr>
				</table>
				<!--location end-->
				<div class="cnt">
	  ...
	  <td>
	    <table width=630 border=0 cellpadding=0 cellspacing=0>
		  ...
		  <tr>
		    ...
		    <td bgcolor='#FFFFFF'>
				<iframe id=ifrm src="/qz_1017/csu/build.do?category_key=1" width="571" height="100%" FRAMEBORDER=0 MARGINHEIGHT=0 MARGINWIDTH=0 SCROLLING=no  HSPACE="0" VSPACE="0" ></iframe>
			</td>
