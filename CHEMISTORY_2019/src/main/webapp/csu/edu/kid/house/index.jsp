...
function fnGo(num) {
	if (num == 1) {	// 게임
		location.href="./house_st01.jsp";
	}
	else if(num==2) {
		location.href="./house_f01.jsp";
	}
	else if(num==3) {
		location.href="./house_f02.jsp";
	}
	else if(num==4) {
		location.href="./house_f03.jsp";
	}
	else if(num==6) {
		location.href="./house_quiz.jsp";
	}
	else if(num==7) {
		window.open('../pdf/house_pdf.pdf');
	}
}
//-->
</script>
		...
		<td id="ly_cnt">
			...
			<div id="ly_dtl">
				...
				<table cellspacing="0" cellpadding="0" class="cnt_title">
					<tr>
						<td><img src="/csu/img/cnt/edu_kis_title01.gif" alt="" title="" /></td>
						<td><div class="lctn_txt"><a href="/csu/">홈으로</a> / <a href="/csu/edu/kid/gate.jsp">케미에듀</a> / 어린이 / 집</div></td>
					</tr>
				</table>
				<!--location end-->
				<div class="cnt">
				<script src='./house_main.js'></script>
				<!--right quick menu-->
				<jsp:include page="./house_right_menu.jsp" flush="true"/>
				<!--right quick menu-->
				</div>
				<!--//////////////////////-cnt area end-//////////////////////-->
			</div>
