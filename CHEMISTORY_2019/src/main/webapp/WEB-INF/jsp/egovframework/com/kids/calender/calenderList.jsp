...
<script type="text/javascript">
	...
	function fn_move_regist() {
		$('#frm').attr("action","<c:url value='/com/kids/calender/calenderRegist.do'/>");
		$('#frm').submit();
	}
	...
	function fn_move_inqire(idx) {
		$('#idx').val(idx);
		$('#frm').attr("action","<c:url value='/com/kids/calender/calenderInqire.do'/>");
		$('#frm').submit();
	}
...
<div id="contents">
	...
	<div class="t_center mt20">
		<a href="javascript:fn_move_calendarView();" class="btn orange">달력보기</a>
