...
<style>
	.adminH2 {background:none !important; font-weight:bold; font-size:24px !important; margin:0px 0px 20px !important; padding:0px 0px 0px 5px !important; color:#333 !important; line-height:22px !important; border-left:5px solid #ccc;}
</style>
<script type="text/javascript" src="<c:url value='/js/egovframework/com/sym/cal/EgovCalPopup.js'/>" ></script>
<script type="text/javascript">
// 	alert("EgovUserLogList.jsp");
 ...
 <table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  ...
	  <td>
	      ...
	      <input name="searchBgnDeView" type="text" size="10" value="<c:out value='${searchVO.searchBgnDeView}'/>"  readOnly
	      ...
	      <input name="searchEndDeView" type="text" size="10" value="<c:out value='${searchVO.searchEndDeView}'/>"  readOnly
