		  ...
		  <tr>
		    <td class="title_left">서비스별 접속 통계
		      <table width="660" class="table-line" border="0">
			    ...
			    <tr>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.statsDate}'/></td>
			      <td class="lt_text6" nowrap>&nbsp;<c:out value='${resultInfo.conectMethod}'/></td>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.creatCo}'/></td>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.updtCo}'/></td>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.inqireCo}'/></td>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.deleteCo}'/></td>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.outptCo}'/></td>
			      <td class="lt_text3" nowrap><c:out value='${resultInfo.errorCo}'/></td>
			    </tr>
			    </c:forEach>
			    </tbody>
		      </table>
		  ...
		  <tr>
		    <td class="title_left">그래프 (단위, 횟수)
		      ...
		      <table width="660" cellpadding="8" class="table-search" border="0">
		        <c:forEach items="${conectStats}" var="resultInfo" varStatus="status">
			      <tr>
			        <td width="100" height="10" class="lt_text3" nowrap><c:out value='${resultInfo.statsDate}'/></td>
			        <td width="560" height="10">
					  <img src="<c:url value='/images/egovframework/com/cmm/left_bg.gif' />" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value='${resultInfo.statsCo}'/>&nbsp;회
					</td>
			      </tr>
			    </c:forEach>
		      </table>
		  ...
		  <tr>
		    <td class="title_left">텍스트 (단위, 횟수)
		      ...
		      <table width="660" cellpadding="8" class="table-search" border="0">
		        <c:forEach items="${conectStats}" var="resultInfo" varStatus="status">
		        <tr>
		          <td><c:out value='${resultInfo.statsDate}'/> &nbsp;&nbsp;&nbsp;<c:out value='${resultInfo.statsCo}'/>&nbsp;회</td>
		        </tr>
		        </c:forEach>
		      </table>
		      <!-- 테이블표 끝 -->
