...
<input type="hidden" name="bannerAtStr" value="1"/>
<input type="hidden" name="searchCondition" value="1">
	<fieldset>
	<legend>목록검색</legend>	
	  	<select id="reflctAtStr" name="reflctAtStr" class="board-search-select">
	  		<option value="">-반영여부-</option>
		  	<option value="Y" <c:if test="${bannerVO.reflctAtStr eq 'Y'}"> selected="selected"</c:if>>Y</option>
		  	<option value="N" <c:if test="${bannerVO.reflctAtStr eq 'N'}"> selected="selected"</c:if>>N</option>
	 	</select>&nbsp;&nbsp;	
		...
		팝업명&nbsp;<input name="searchKeyword" type="text" value="<c:out value="${bannerVO.searchKeyword}"/>" size="25" onkeypress="press();" id="searchKeyword" class="board-search-keyword" />
...
<div class="board-list">
	<table class="board-default">
		...
		<thead>
			<tr>
				<th class="board-default-th-title">팝업 명</th>
				<th class="board-default-th-title"">사이트구분명</th>
				<th class="board-default-th-title">팝업 설명</th>
