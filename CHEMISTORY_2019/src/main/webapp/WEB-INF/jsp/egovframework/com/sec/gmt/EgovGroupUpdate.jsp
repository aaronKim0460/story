...
<input type="hidden" name="pageIndex" value="<c:out value='${groupManageVO.pageIndex}'/>"/>
	...
	<caption>글 등록</caption>
		...
		<tr>
			<th class="board-write-th">그룹 ID</th>
			<td class="board-write-td"><input id="groupId" name="groupId" type="text" value="<c:out value='${groupManage.groupId}'/>" class="input-text" readonly="readonly" size="40" title="그룹ID" /></td>
		</tr>

		<tr>
		    <th class="board-write-th">그룹 명<i class="board-required"><span class="hide"></span></i></th>
		    <td class="board-write-td"><input id="groupNm" name="groupNm" type="text" value="<c:out value='${groupManage.groupNm}'/>" class="input-text" maxLength="50" size="40" title="그룹명"/></td>
		</tr>
      ...
      <!-- 
	   ...
	   -->
      	...
      	<a href="javascript:fncGroupUpdate();" class="btn btn-primary">수정</a>
      	<a href="javascript:fncGroupDelete();" class="btn btn-warning">삭제</a>
	</div>
</form:form>
</div>
</div>
