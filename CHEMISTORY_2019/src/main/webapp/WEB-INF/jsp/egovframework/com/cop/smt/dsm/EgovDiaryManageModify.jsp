...
<!-- 
  ...
  <td>&nbsp;</td>
  <td><img src="<c:url value='/images/egovframework/com/cmm/button/bu2_left.gif'/>" width="8" height="20" alt="버튼이미지"></td>
  <td background="<c:url value='/images/egovframework/com/cmm/button/bu2_bg.gif' />" class="text_left" nowrap><a href="JavaScript:fn_egov_save_DiaryManage(document.forms[0]);"><spring:message code="button.save" /></a>
  </td>
  <td><img src="<c:url value='/images/egovframework/com/cmm/button/bu2_right.gif'/>" width="8" height="20" alt="버튼이미지"></td>
 -->
...
<input name="diaryId" id="diaryId" type="hidden" value="<c:out value='${diaryManageVO.diaryId}'/>">
