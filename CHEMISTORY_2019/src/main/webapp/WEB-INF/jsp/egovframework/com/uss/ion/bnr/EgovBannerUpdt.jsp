...
<input type="hidden" name="bannerAtStr" value="<c:out value='${bannerAtStr }'/>"/>
<input type="hidden" name="bannerAt" value="0" />
<!-- 검색조건 유지 -->
	...
	<caption>배너/알림 수정</caption>
		...
		<tbody>
			...
			<tr>
				...
				<td class="board-write-td">
			    	<input name="bannerNm" id="bannerNm" class="input-text full" type="text" value="<c:out value='${banner.bannerNm}'/>" maxLength="10" size="30" >
