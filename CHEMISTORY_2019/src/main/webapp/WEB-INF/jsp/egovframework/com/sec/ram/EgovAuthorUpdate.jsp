...
<input type="hidden" name="pageIndex" value="<c:out value='${authorManageVO.pageIndex}'/>"/>
	...
	<caption>글 등록</caption>
		...
		<tr>
			<th class="board-write-th">권한코드<i class="board-required"><span class="hide"></span></i></th>
			<td class="board-write-td"><input id="authorCode" name="authorCode" type="text" value="<c:out value='${authorManage.authorCode}'/>" class="input-text" readonly="readonly" size="40" title="권한코드" /></td>
		</tr>

		<tr>
		    <th class="board-write-th">권한 명<i class="board-required"><span class="hide"></span></i></th>
		    <td class="board-write-td"><input id="authorNm" name="authorNm" type="text" value="<c:out value='${authorManage.authorNm}'/>" class="input-text" maxLength="50" size="40" title="권한명"/></td>
		</tr>
      ...
      <!-- 
	   ...
	   -->
      	...
      	<a href="javascript:fncAuthorUpdate();" class="btn btn-primary">수정</a>
      	<a href="javascript:fncAuthorDelete();" class="btn btn-warning">삭제</a>
	</div>
</form:form>
</div>
</div>
