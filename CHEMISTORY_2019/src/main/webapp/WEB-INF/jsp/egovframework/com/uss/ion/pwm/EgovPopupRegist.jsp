...
<table class="board-write">
	<caption>배너/알림 등록</caption>
	  ...
	  <tr>
	    ...
	    <td class="board-write-td">
	      <form:input path="fileUrl" size="73" cssClass="input-text" value="egovframework/com/uss/ion/pwm/sample/EgovPopupSample" maxlength="255"/>
	  ...
	  <tr>
	    <th class="board-write-th" ><label id="IdPopupWSize">팝업창사이즈</label><img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
	    <td class="board-write-td">
	  ...
	  <tr>
	    <th rowspan="2" class="board-write-th" nowrap><label id="IdNtceEnddeHH">게시 기간</label><img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
	    <td class="board-write-td">
	    	<input id="ntceBgndeYYYMMDD" name="ntceBgndeYYYMMDD" type="hidden" value="" />
			<input name="ntceBgndeYYYMMDDView" id="ntceBgndeYYYMMDDView" type="text" class="search-date-picker" style="width:140px" value="" readOnly />
			&nbsp;&nbsp;&nbsp;
		    ...
		    </form:select>M <strong>~</strong>
	    </td>
	  </tr>
	  <tr>
	  	<td class="board-write-td">
	  		<input id="ntceEnddeYYYMMDD" name="ntceEnddeYYYMMDD" type="hidden" value="" />
			<input name="ntceEnddeYYYMMDDView" id="ntceEnddeYYYMMDDView" type="text" class="search-date-picker" style="width:140px" value="" readOnly />
			&nbsp;&nbsp;&nbsp;
	  ...
	  <tr>
	  	<td class="board-write-editor" colspan="2">
				<textarea id="popupCn" name="popupCn" class="textarea-board" cols="75" rows="20"></textarea>
	  ...
	  <tr>
	    <th class="board-write-th" ><label id="IdNtceAt">계시 상태</label><img src="${ImgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
	    <td class="board-write-td">
...
<div class="text-center">
	...
	<input type="submit" value="등록" onclick="fn_egov_save_PopupManage()(); return false;" class="btn btn-primary" />
</div>
