...
// 	        			chked_age = chked_age.substring(1);
	        	 ...
	        	 $.ajax({
        			type: "POST"
        			,url: "<c:url value='/adm/contents/material/insertNoxiousInfo.do'/>"
        			,data:$("#formNoxiousInfo").serialize()
        			,success: function(result){
        	          if(result == "success"){
        	        	  alert("등록이 성공적으로 완료 되었습니다");
        	        	  doList();
        	          }else if(result == "validateErr"){
        	        	  alert("파라미터에 문제가 있습니다.");
        	          }else{
        	        	  alert("등록에 문제가 있습니다. 관리자에게 문의해 주세요");
        	          }
        	      }
        		}); 
...
<input name="rdMidx" id="rdMidx" type="hidden" value=""/>
<input name="rdEname" id="rdEname" type="hidden" value=""/>
		...
		<tbody>
			<tr>
				...
				<td>
					...
					<input type="text" name="rdKname" id="rdKname" value="" readonly="readonly"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<textarea id="rdPoison" name="rdPoison" rows="5" cols="100"></textarea>
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<textarea id="rdPlan" name="rdPlan" rows="5" cols="100"></textarea>
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<textarea id="rdIn" name="rdIn" rows="5" cols="100"></textarea>
				</td>
			</tr>			
			<tr>
				<th scope="row">
				...
				<td>
					<textarea id="rdSource" name="rdEtc" rows="5" cols="100"></textarea>
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<textarea id="rdSource" name="rdSource" rows="5" cols="100"></textarea>
				</td>
			</tr>
			<tr>
