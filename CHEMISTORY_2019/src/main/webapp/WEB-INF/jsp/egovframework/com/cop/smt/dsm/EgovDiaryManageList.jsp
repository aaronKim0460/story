...
<tr>
    ...
    <td class="lt_text3L" nowrap>
   		<form name="subForm" method="post" action="<c:url value='/cop/smt/dsm/EgovDiaryManageDetail.do'/>">
			...
			<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
    		<span class="link"><input type="submit" style="width:320px;border:solid 0px black;text-align:left;" value="<c:out value="${resultInfo.diaryNm}"/>" onclick="fn_egov_detail_DiaryManage('<c:out value='${resultInfo.diaryId}'/>'); return false;"></span>
    	</form>
    </td>
