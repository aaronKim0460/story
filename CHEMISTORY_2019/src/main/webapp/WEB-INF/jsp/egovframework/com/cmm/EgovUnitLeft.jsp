	...
	<c:forEach var="result" items="${resultList}" varStatus="status">
		...
		<tr height = "16">
		    <td align="left" valign="center" width="100%">
		    	<a href="<c:out value='${pageContext.request.contextPath}'/><c:out value="${result.listUrl}"/>" target="_content" class="link"> <c:out value="${result.order}"/>. <c:out value="${result.name}"/></a>
			</td>
		</tr>
	</c:forEach>
</table>
