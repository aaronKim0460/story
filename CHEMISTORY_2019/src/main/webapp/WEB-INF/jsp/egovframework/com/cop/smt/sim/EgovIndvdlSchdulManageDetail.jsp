...
sLinkType = EgovWebUtil.clearXSSMinimum(sLinkType);
%>
...
<input name="schdulId" type="hidden" value="<c:out value='${resultList[0].schdulId}'/>">
<input name="linkType" type="hidden" value="<c:out value='${sLinkType}'/>">
