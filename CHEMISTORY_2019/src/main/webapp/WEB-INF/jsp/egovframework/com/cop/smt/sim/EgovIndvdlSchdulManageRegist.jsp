...
function fn_egov_init_IndvdlSchdulManage(){
	   ...
	   if("<c:out value='${indvdlSchdulManageVO.schdulBgnde}'/>".length > 0){
		   var schdulBgnde = "<c:out value='${indvdlSchdulManageVO.schdulBgnde}'/>";
	   ...
	   if("<c:out value='${indvdlSchdulManageVO.schdulEndde}'/>".length > 0){
		   var schdulEndde = "<c:out value='${indvdlSchdulManageVO.schdulEndde}'/>";
