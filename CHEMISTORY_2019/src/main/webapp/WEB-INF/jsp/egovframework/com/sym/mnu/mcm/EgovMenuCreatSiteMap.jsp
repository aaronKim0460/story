  ...
  <td width="480">
    <table width="480" border="0" cellpadding="0" cellspacing="1" class="table-register">
      <tr>
        ...
        <td width="330"><input name="authorCode" type="text" size="20" value="<c:out value='${resultVO.authorCode}'/>"  maxlength="30" readonly title="권한명"/>
        <input name="chkCreat" type="text" size="10" value="<c:out value='${resultBoolean.chkCreat}'/>"  maxlength="10" readonly title="권한코드">
        </td>
