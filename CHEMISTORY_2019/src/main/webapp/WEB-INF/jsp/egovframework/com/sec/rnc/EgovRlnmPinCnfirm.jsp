...
<body>
        ...
        <input type="hidden" name="ihidnum" value="<c:out value='${ihidnum}'/>">
        <input type="hidden" name="realName" value="<c:out value='${realName}'/>"><!-- ipin실명확인된 이름realName변수와 구별 -->
        <!-- 실명인증을 재귀적으로 호출하는 경우 다음경로와 다음경로 버튼명을 셋팅함 -->
        <input type="hidden" name="realName" value="<c:out value='${realName}'/>">
        ...
        <table width="717" border="0"  cellspacing="0" cellpadding="0">
            <tr>
                <td>
                    <input type="hidden" name="sbscrbTy_view" value="<c:out value='${sbscrbTy}'/>">
                    ...
                    <br><c:if test="${not empty realName}">실명확인이름: <c:out value='${realName}'/> </c:if>
                    <br>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td align="left"><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
                     -->
                    <td><span class="button"><input type="submit" value="<spring:message code="<c:out value='${nextUrlName}'/>" />" title="<spring:message code="<c:out value='${nextUrlName}'/>" />" onclick="javascript:fnNextMov();return false;"></span></td>
	            </tr>
	            </table>
	            </td>
            </tr>
