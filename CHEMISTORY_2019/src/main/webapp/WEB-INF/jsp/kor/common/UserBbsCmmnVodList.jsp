...
<div id="contents">
	...
	<li class="clearfix">
			...
			<div class="substance">
				...
				<div>
					<a class="movie" href="#/user/cop/bbs/selectBoardArticle.do?nttId=<c:out value='${result.nttId}'/>&amp;bbsId=<c:out value='${result.bbsId}'/>&amp;menuNo=<c:out value='${menuManageVO.menuNo}'/>" title="<c:out value="${result.nttSj}"/>" 
