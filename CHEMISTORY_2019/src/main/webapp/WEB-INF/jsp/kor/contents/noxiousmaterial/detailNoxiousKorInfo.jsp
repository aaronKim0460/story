...
doList = function(){
	document.formInfo.action = "<c:url value='/kor/material/chemistry.do'/>";
...
<input name="searchKeyword" id="searchKeyword" type="hidden" value="<c:out value="${ivo.searchKeyword}"/>"/>
	...
	<colgroup>
		...
		<tbody>
			...
			<tr>
				...
				<td>
<pre><c:choose><c:when test="${detail.rdPlanCh eq 'Y'}"><c:out value="${detail.rdPlan}" escapeXml="false"/></c:when>
<c:otherwise><c:out value="${detail.rdPlan}"/></c:otherwise></c:choose></pre>					
				</td>
			</tr>
			<tr>
				<th scope="row">노출및 저감방안</th>
				<td>
<pre><c:choose><c:when test="${detail.rdInCh eq 'Y'}"><c:out value="${detail.rdIn}" escapeXml="false"/></c:when>
<c:otherwise><c:out value="${detail.rdIn}"/></c:otherwise></c:choose></pre>
				</td>
			</tr>			
			<tr>
				<th scope="row">기타</th>
				<td>
<pre>
<c:choose><c:when test="${detail.rdEtcCh eq 'Y'}"><c:out value="${detail.rdEtc}" escapeXml="false"/></c:when>
<c:otherwise><c:out value="${detail.rdEtc}"/></c:otherwise></c:choose></pre>
				</td>
			</tr>
			<tr>
				<th scope="row">출처</th>
